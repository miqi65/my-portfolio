...
const cases: CaseItem[] = [
  ...
  {
    num: '02',
    metaLabel: '02 / Industrial Software',
    name: 'PCBA 插件机系统',
    description:
  ...
  {
    num: '03',
    metaLabel: '03 / Product Validation',
    name: 'AI辅助工作流',
    description:
      '把模糊需求拆解为业务问题、用户路径、可演示 Demo 与开发前风险清单，让团队先判断方向。',
    tags: ['产品验证', '方法演示', '风险清单'],
    href: '/projects/P3',
    previewMain: '/images/p3_assets/p3-card-cover.png',
    previewAlt: 'AI 辅助产品方案验证与交付方法封面图',
    previewPosition: 'object-top',
    info: [
      { label: '案例类型', value: '方法演示' },
      { label: '场景来源', value: '工业AI' },
      { label: '我的角色', value: '产品设计' },
    ],
  },
]
